        ...
        <div class = "content"><!--body content holder-->
            ...
            <div class="container">
                <div class="col-md-6 contacts">
                    <h1 style="color:#000080 ; font-size:42px ; font-style:bold "><span class="glyphicon glyphicon-user"></span> Venugopal D A</h1>
                    <p>
                        <span class="glyphicon glyphicon-envelope"></span> Email: gobiarts&science1968@gmail.com<br>
